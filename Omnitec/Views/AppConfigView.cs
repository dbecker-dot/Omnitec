...
{
    public partial class AppConfigView : Form
    {
        ...
        private void btnUsuarioAdministrador_Click(object sender, EventArgs e)
        {
            Omnitec.Views.frmusuarioadministradorapp fm = new Omnitec.Views.frmusuarioadministradorapp();
            fm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(fm);
        }

        private void btnconfigbdpulse_Click(object sender, EventArgs e)
        {
            Omnitec.Views.frmconfigbasededatosPulse frm = new Omnitec.Views.frmconfigbasededatosPulse();
            frm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(frm);
        }

        private void btnconfigbdomnitec_Click(object sender, EventArgs e)
        {
            Omnitec.Views.frmconfigbasededatosOmnitec frm = new Omnitec.Views.frmconfigbasededatosOmnitec();
            frm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(frm);
        }
        ...
        {
            AbrirFormEnPanel(new Omnitec.Views.frmadmclientes());
        }
