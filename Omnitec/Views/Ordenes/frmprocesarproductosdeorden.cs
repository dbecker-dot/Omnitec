...
{
    public partial class frmprocesarproductosdeorden : Form
    {
        ...
        int idordenasoc = 0;
        public frmprocesarproductosdeorden(frmMenuPrincipal principal)
        {
            InitializeComponent();
            this.principal = principal;
        }

        private void frmprocesarproductosdeorden_Load(object sender, EventArgs e)
        {
        ...
        private void ActivarDesactivarCheck(bool vBool)
        {
            ...
            {
                row.Cells["seleccionar"].Value = vBool;
            }
        }
