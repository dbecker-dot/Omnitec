...
namespace CapaDatos.Services
{
    public class WinTheme
    {
        ...
        private static readonly Color FuenteTituloD = Color.White;
        ...
        private static readonly Color FuenteTituloA = Color.White;
        ...
        private static readonly Color FuenteTituloV = Color.White;
